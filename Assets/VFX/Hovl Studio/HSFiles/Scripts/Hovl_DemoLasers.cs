...
public class Hovl_DemoLasers : MonoBehaviour
{
    ...
    {
        //Enable lazer
        bool mouseLeftDown = UnityEngine.InputSystem.Mouse.current != null && UnityEngine.InputSystem.Mouse.current.leftButton.wasPressedThisFrame;
        if (mouseLeftDown)
        {
            Destroy(Instance);
        ...
        bool mouseLeftUp = UnityEngine.InputSystem.Mouse.current != null && UnityEngine.InputSystem.Mouse.current.leftButton.wasReleasedThisFrame;
        if (mouseLeftUp)
        {
