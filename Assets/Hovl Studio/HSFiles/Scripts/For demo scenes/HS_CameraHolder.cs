...
public class HS_CameraHolder : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        if (UnityEngine.InputSystem.Mouse.current != null)
        {
            ...
            // Normalize scroll value from new Input System (usually ~120 on windows) to ~0.1
            scroll = (scroll / 120f) * 0.1f;

            isMouseButtonDown = UnityEngine.InputSystem.Mouse.current.leftButton.isPressed || 
        ...
        currDistance -= scroll * 2;
        if (Holder && isMouseButtonDown)
        {
            ...
            // new Input System delta is raw pixels, old Mouse X/Y were smoothed values.
            // Scale delta by 0.05f to match the original speed and feel.
            x += (float)(mouseDelta.x * 0.05f * xRotate * 0.02);
            y -= (float)(mouseDelta.y * 0.05f * yRotate * 0.02);
